          ...
          <div className="grid grid-cols-12 mt-5 gap-8">
            ...
            <div className="col-span-12 xl:col-span-7 xxl:col-span-6 order-1 xl:order-2">
              <div className="p-6 sm:p-14 xxl:p-20">
                ...
                At Goldy Crypto Cash, we believe in combining the fun of crypto with the speed and innovation of Solana! Our mission is to bring you a decentralized, community-driven asset that blends hype, humor, and utility. Say hello to Goldy Crypto Cash – the crypto coin that shines brighter than gold, fueled by fast transactions, low fees, and pure degen energy.
                </p>
              </div>
            </div>
          </div>
